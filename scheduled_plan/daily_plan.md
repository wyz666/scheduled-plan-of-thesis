...
<font color='red'> 未完成 </font>进度：1220，3.2.2

## 6.2任务
#### 撰写论文
从3.2.2开始，至少完成核心部分建模，完成遗传算法求解步骤。  
<font color='red'> 未完成 </font>进度：1046，3.3.1

## 6.3任务
#### 撰写论文
3.3.1开始，完成建模  
<font color='red'> 未完成 </font>进度：0

## <font color='LimeGreen'> 6.4总结 </font>
进度：272，3.3.2  
第三章进度：4508
...
3.3.2开始，张量生命周期编码  
初始化种群设计  
<font color='LimeGreen'> 6.6完成 </font>  
适应度函数设计
<font color='red'> 未完成 </font>进度：0
#### 汇报进度
<font color='LimeGreen'> 完成 </font>6.7号再给一版给张老师

## <font color='LimeGreen'> 6.6总结 </font>
进度：585，3.3.3  
确定了编码和初始化方法
...
#### 汇报进度
找老师探讨显存碎片地具体解决方案  
<font color='LimeGreen'> 完成 </font>：按照目前的建模方案，得到确定的调度顺序，在一块固定的缓存区对张量进行预分配存储位置的操作，拟采用动态存储规划算法。同时将遗传算法的实现细节完善一下

## <font color='LimeGreen'> 6.9总结 </font>
第三章理论 进度：6283  
完成至3.3.3遗传算法流程图  
